...
This repository authors a docs site + Terraform demo; it does not apply stacks on the agent's behalf.
Creating outbound endpoints, VPCs, or EC2 costs money and leaves resources
...
ALLOW_ENV = "R53_OUTBOUND_ALLOW_AWS"
